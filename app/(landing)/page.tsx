      ...
      <main>
          ...
          <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2">
            <div className="relative space-y-6">
              ...
              <div className="flex flex-col gap-4 pt-4 sm:flex-row">
                <Link href="/sign-up" className="h-full w-full">
                  <Button className="w-full cursor-pointer rounded-full border border-black bg-transparent text-black hover:bg-amber-500 hover:text-white">
                    GET STARTED
                  </Button>
                </Link>
              </div>
        ...
        <section className="container mx-auto px-8 py-16">
          <div className="rounded-3xl bg-gradient-to-r from-teal-700 to-teal-900 px-8 py-12 text-center text-white sm:p-12">
            ...
            <Link href="/sign-up" className="mx-auto w-fit">
